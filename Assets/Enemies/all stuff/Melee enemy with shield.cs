...
public class Meleeenemywithshield : Enemy
{
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawWireCube(boxCollider2.bounds.center + range * transform.localScale.x * transform.right, new Vector3(boxCollider2.bounds.size.x * size, boxCollider2.bounds.size.y, boxCollider2.bounds.size.z));
    }
